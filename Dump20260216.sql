<<<<<<<< HEAD:back-end/db/Dump20260218.sql
...
LOCK TABLES `products` WRITE;
/*!40000 ALTER TABLE `products` DISABLE KEYS */;
INSERT INTO `products` VALUES (1,'Bootleg Jeans','High quality denim bootleg jeans',250.00,'30','Pants','bootlegged-jeans.png',10,'2026-02-16 10:57:45'),(2,'Nike Air Force 1','Classic white Nike sneakers with cushioned sole',550.00,'42','Sneakers','nike-af1.png',15,'2026-02-16 11:00:36'),(3,'Converse Sneakers','Classic canvas Converse sneakers',385.00,'41','Sneakers','converse.png',20,'2026-02-16 11:00:36'),(4,'Oversized Hoodie','Comfortable oversized cotton hoodie',450.00,'M','Hoodies','oversized-hoodie.png',25,'2026-02-16 11:00:36'),(5,'Varsity Jacket','Stylish varsity jacket with leather sleeves',300.00,'L','Jackets','varsity-jacket.png',8,'2026-02-16 11:00:36'),(6,'Leather Jacket','Premium black leather jacket',450.00,'L','Jackets','leather-jacket.png',5,'2026-02-16 11:00:36'),(7,'Graphic Tee','Trendy printed cotton graphic t-shirt',60.00,'M','T-Shirts','graphic-tee.png',30,'2026-02-16 11:00:36'),(8,'Casio','Custom strapped,brown casio watch',380.00,'adjustable','accessories','casio.pnj',1,'2026-02-16 12:55:54'),(20,'Assorted keychain',' Multie asssorted keychain/s',25.00,'none','accessories','keychain.pnj',NULL,'2026-02-16 13:11:51');
/*!40000 ALTER TABLE `products` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-02-16 15:13:32
>>>>>>>> main:Dump20260216.sql

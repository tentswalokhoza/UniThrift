...
--
-- Host: localhost    Database: uni_mock
-- ------------------------------------------------------
...
CREATE TABLE `seller_reviews` (
  ...
  CONSTRAINT `seller_reviews_ibfk_1` FOREIGN KEY (`seller_id`) REFERENCES `users` (`id`),
  CONSTRAINT `seller_reviews_ibfk_2` FOREIGN KEY (`reviewer_id`) REFERENCES `users` (`id`),
...
-- Dump completed on 2026-02-18 14:36:06
